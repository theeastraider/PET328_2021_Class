...
pi = float(input("Enter the value of the initial reservoir pressure?:"))
ce = float(input("Enter the value of the effective compressibility factor?:"))
co = float(input("Enter the value of oil compressibility?:"))
boi = float(input("Enter the value of the initial oil FVF?:"))
